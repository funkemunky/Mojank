...
public class CustomHopper extends BlockContainer {
    ...
    public void postPlace(World world, int i, int j, int k, EntityLiving entityliving, ItemStack itemstack) {
        ...
        if (itemstack.hasName()) {
            CustomTileHopper tileentityhopper = e((IBlockAccess)world, i, j, k);
    ...
    private void e(World world, int i, int j, int k) {
        ...
        if (flag != flag1) {
            ...
            if (world.spigotConfig.altHopperTicking) {
                CustomTileHopper hopper = e((IBlockAccess)world, i, j, k);
                if (flag && hopper != null) {
                    hopper.makeTick();
                }
            }
    ...
    public void remove(World world, int i, int j, int k, Block block, int l) {
        CustomTileHopper tileentityhopper = (CustomTileHopper)world.getTileEntity(i, j, k);
        if (tileentityhopper != null) {
    ...
    public static CustomTileHopper e(IBlockAccess iblockaccess, int i, int j, int k) {
        return (CustomTileHopper)iblockaccess.getTileEntity(i, j, k);
    }
